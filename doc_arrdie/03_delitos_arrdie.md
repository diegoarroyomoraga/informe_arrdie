...
La explotación de la vulnerabilidad permitió alterar el funcionamiento seguro de la infraestructura tecnológica, dejando expuestos servidores y bases de datos internas. Aunque el objetivo principal del ataque fue la obtención de información, la intrusión comprometió la estabilidad y seguridad operacional de los sistemas afectados.
...
La conducta realizada por los atacantes se relaciona directamente con el delito de acceso ilícito establecido en la Ley 21.459, ya que los responsables ingresaron deliberadamente a sistemas protegidos sin autorización del titular.
...
Los atacantes lograron acceder a información altamente sensible, incluyendo nombres, fechas de nacimiento, direcciones, números de seguridad social y datos financieros. La obtención ilícita de esta información representa una afectación directa a la protección de los datos informáticos contemplada por la ley chilena.
...
La Ley 21.459 contempla responsabilidad respecto a quienes utilicen, comercialicen o mantengan en su poder información obtenida mediante delitos informáticos.
...
Aunque el objetivo inicial del ataque fue la extracción de información, los datos obtenidos permitían realizar actividades fraudulentas utilizando la identidad de las víctimas afectadas.

La exposición de números de seguridad social, datos financieros y antecedentes personales aumentó considerablemente el riesgo de fraudes económicos y delitos financieros posteriores al incidente.
