...
|---|---|---|---|---|---|
| Ley 21.459 sobre Delitos Informáticos | Regula delitos informáticos como acceso ilícito, fraude informático y ataques a sistemas. | Contempla sanciones penales y penas privativas de libertad según el delito cometido. | Personas que cometan delitos informáticos o vulneren sistemas tecnológicos. | Chile | Aplica debido al acceso no autorizado a los sistemas de Equifax y a la extracción ilegal de información confidencial mediante explotación de vulnerabilidades. |
| Ley 19.628 sobre Protección de la Vida Privada | Regula el tratamiento, almacenamiento y protección de datos personales. | Establece responsabilidades por uso indebido o exposición de datos personales. | Empresas y organizaciones que almacenan o procesan datos personales. | Chile | Resulta aplicable porque Equifax almacenaba información personal y financiera sensible de millones de usuarios afectados por la filtración. |
| FTC Act | Protege a consumidores frente a prácticas comerciales injustas o engañosas. | Permite investigaciones, acuerdos regulatorios y sanciones económicas contra empresas. | Empresas y organizaciones comerciales. | Estados Unidos | Fue utilizada por autoridades estadounidenses para investigar y sancionar a Equifax debido a deficiencias en sus medidas de seguridad informática. |
...
La FTC Act y la GLBA poseen un alcance más relacionado con protección del consumidor y resguardo de información financiera dentro del sector crediticio y comercial.
...
El GDPR contempla algunas de las multas económicas más altas a nivel internacional respecto a protección de datos personales. Por otro lado, la FTC Act permite investigaciones y sanciones económicas contra empresas que no implementen medidas razonables de seguridad.
...
La Ley 19.628, el GDPR y la GLBA regulan principalmente organizaciones y empresas que recopilan, almacenan o procesan información personal y financiera de usuarios.

La FTC Act posee un alcance amplio sobre empresas y organizaciones comerciales que mantengan relaciones con consumidores.
...
La FTC Act y la GLBA corresponden a regulaciones estadounidenses aplicadas directamente al caso Equifax debido a que la empresa opera en Estados Unidos.

El GDPR pertenece a la Unión Europea y se utiliza como referencia internacional sobre protección de datos personales y responsabilidad empresarial frente a brechas de seguridad.

La combinación de regulaciones nacionales e internacionales permite analizar el caso desde distintas perspectivas jurídicas relacionadas con delitos informáticos, protección de datos y responsabilidad corporativa.